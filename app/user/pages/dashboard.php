...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat <?= $salam; ?>, Selamat datang <b><?= $_SESSION['fullname']; ?> di Perpustakaan Digital.
        </div>
        <!-- -->
        <?php
        include "../../config/koneksi.php";
        ...
        <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMK PALAPA</h2>
            <p class="text-center">Jl. Cut Nyak Dien Gg. Surya Dien No.87 / 6, Palapa, Kec. Tj. Karang Pusat, Kota Bandar Lampung, Lampung </p>
